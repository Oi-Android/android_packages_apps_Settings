...
public class AppSidebar extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mEnabledPref.setChecked((Settings.OI.getInt(getContentResolver(),
                Settings.OI.APP_SIDEBAR_ENABLED, 0) == 1));
        mEnabledPref.setOnPreferenceChangeListener(this);

        mHideLabelsPref = (SwitchPreference) findPreference(KEY_HIDE_LABELS);
        mHideLabelsPref.setChecked((Settings.OI.getInt(getContentResolver(),
                Settings.OI.APP_SIDEBAR_DISABLE_LABELS, 0) == 1));

        PreferenceScreen prefSet = getPreferenceScreen();
        mPositionPref = (ListPreference) prefSet.findPreference(KEY_POSITION);
        mPositionPref.setOnPreferenceChangeListener(this);
        int position = Settings.OI.getInt(getContentResolver(), Settings.OI.APP_SIDEBAR_POSITION, 0);
        ...
        mTransparencyPref.setValue(Settings.OI.getInt(getContentResolver(),
                Settings.OI.APP_SIDEBAR_TRANSPARENCY, 0));
        ...
        mTriggerWidthPref.setValue(Settings.OI.getInt(getContentResolver(),
                Settings.OI.APP_SIDEBAR_TRIGGER_WIDTH, 10));
        mTriggerWidthPref.setOnPreferenceChangeListener(this);

        mTriggerTopPref = (SeekBarPreferenceCham) findPreference(KEY_TRIGGER_TOP);
        mTriggerTopPref.setValue(Settings.OI.getInt(getContentResolver(),
                Settings.OI.APP_SIDEBAR_TRIGGER_TOP, 0));
        mTriggerTopPref.setOnPreferenceChangeListener(this);

        mTriggerBottomPref = (SeekBarPreferenceCham) findPreference(KEY_TRIGGER_BOTTOM);
        mTriggerBottomPref.setValue(Settings.OI.getInt(getContentResolver(),
                Settings.OI.APP_SIDEBAR_TRIGGER_HEIGHT, 100));
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mTransparencyPref) {
            ...
            Settings.OI.putInt(getContentResolver(),
                    Settings.OI.APP_SIDEBAR_TRANSPARENCY, transparency);
            return true;
        } else if (preference == mTriggerWidthPref) {
            int width = ((Integer)newValue).intValue();
            Settings.OI.putInt(getContentResolver(),
                    Settings.OI.APP_SIDEBAR_TRIGGER_WIDTH, width);
            return true;
        } else if (preference == mTriggerTopPref) {
            int top = ((Integer)newValue).intValue();
            Settings.OI.putInt(getContentResolver(),
                    Settings.OI.APP_SIDEBAR_TRIGGER_TOP, top);
            return true;
        } else if (preference == mTriggerBottomPref) {
            int bottom = ((Integer)newValue).intValue();
            Settings.OI.putInt(getContentResolver(),
                    Settings.OI.APP_SIDEBAR_TRIGGER_HEIGHT, bottom);
            return true;
            ...
            Settings.OI.putInt(getContentResolver(),
                    Settings.OI.APP_SIDEBAR_ENABLED,
                    value ? 1 : 0);
            return true;
        }
        return false;
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (preference == mHideLabelsPref) {
            ...
            Settings.OI.putInt(getContentResolver(),
                    Settings.OI.APP_SIDEBAR_DISABLE_LABELS,
                    value ? 1 : 0);
        } else {
    ...
    private void updatePositionSummary(int value) {
        ...
        Settings.OI.putInt(getContentResolver(),
                Settings.OI.APP_SIDEBAR_POSITION, value);
    }
    ...
    public void onPause() {
        super.onPause();
        Settings.OI.putInt(getContentResolver(),
                Settings.OI.APP_SIDEBAR_SHOW_TRIGGER, 0);
    }
    ...
    public void onResume() {
        ...
        Settings.OI.putInt(getContentResolver(),
                Settings.OI.APP_SIDEBAR_SHOW_TRIGGER, 1);
    }
}
