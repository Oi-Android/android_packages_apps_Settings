...
public class WakeLockBlocker extends SettingsPreferenceFragment {
                ...
                .setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(CompoundButton v, boolean checked) {
                        ...
                        Settings.OI.putInt(getActivity().getContentResolver(),
                                Settings.OI.WAKELOCK_BLOCKING_ENABLED,
                                checked?1:0);
    ...
    private boolean isFirstEnable() {
        return Settings.OI.getString(getActivity().getContentResolver(),
                Settings.OI.WAKELOCK_BLOCKING_ENABLED) == null;
    }

    private void updateSwitches() {
        mBlockerEnabled.setChecked(Settings.OI.getInt(getActivity().getContentResolver(),
                Settings.OI.WAKELOCK_BLOCKING_ENABLED, 0)==1?true:false);
    ...
    private void updateBlockedWakeLocksList() {
        String blockedWakelockList = Settings.OI.getString(getActivity().getContentResolver(),
                Settings.OI.WAKELOCK_BLOCKING_LIST);
    ...
    private void save(){
        ...
        Settings.OI.putString(getActivity().getContentResolver(),
                Settings.OI.WAKELOCK_BLOCKING_LIST, buffer.toString());
    }
