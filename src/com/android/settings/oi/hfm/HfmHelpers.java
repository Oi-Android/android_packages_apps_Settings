...
import com.android.settings.oi.hfm.HfmSettings;
...
public final class HfmHelpers {
    ...
    public static void checkStatus(Context context, boolean applyWhitelist) {
        ...
        try {
            boolean adsDisabled = Settings.OI.getInt(context.getContentResolver(), Settings.OI.HFM_DISABLE_ADS, 0) == 1;
