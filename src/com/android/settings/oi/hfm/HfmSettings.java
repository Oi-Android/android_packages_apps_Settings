...
package com.android.settings.oi.hfm;
...
import com.android.settings.oi.hfm.FetchHosts;
import com.android.settings.oi.hfm.HfmHelpers;
import com.android.settings.oi.hfm.HfmWhitelist;
...
public class HfmSettings extends SettingsPreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mHfmDisableAds.setChecked((Settings.OI.getInt(resolver,
            Settings.OI.HFM_DISABLE_ADS, 0) == 1));
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if  (preference == mHfmDisableAds) {
            ...
            Settings.OI.putInt(getActivity().getContentResolver(),
                Settings.OI.HFM_DISABLE_ADS, checked ? 1:0);
            if (checked) {
                mHfmWhitelist.setEnabled(true);
            } else {
                mHfmWhitelist.setEnabled(false);
