...
public class OmniSwitch extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.oi_omniswitch);
        ...
        try {
            mRecentsUseOmniSwitch.setChecked(Settings.OI.getInt(resolver,
                    Settings.OI.RECENTS_USE_OMNISWITCH) == 1);
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        ...
        if (preference == mRecentsUseOmniSwitch) {
            ...
            Settings.OI.putInt(
                    resolver, Settings.OI.RECENTS_USE_OMNISWITCH, value ? 1 : 0);
