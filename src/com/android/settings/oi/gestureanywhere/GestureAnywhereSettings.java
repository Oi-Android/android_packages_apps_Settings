...
package com.android.settings.oi.gestureanywhere;
...
public class GestureAnywhereSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mEnabledPref.setChecked((Settings.OI.getInt(getContentResolver(),
                Settings.OI.GESTURE_ANYWHERE_ENABLED, 0) == 1));
        ...
        int position = Settings.OI.getInt(getContentResolver(),
                Settings.OI.GESTURE_ANYWHERE_POSITION, Gravity.LEFT);
        ...
        mTriggerWidthPref.setValue(Settings.OI.getInt(getContentResolver(),
                Settings.OI.GESTURE_ANYWHERE_TRIGGER_WIDTH, 10));
        ...
        mTriggerTopPref.setValue(Settings.OI.getInt(getContentResolver(),
                Settings.OI.GESTURE_ANYWHERE_TRIGGER_TOP, 0));
        ...
        mTriggerBottomPref.setValue(Settings.OI.getInt(getContentResolver(),
                Settings.OI.GESTURE_ANYWHERE_TRIGGER_HEIGHT, 100));
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mPositionPref) {
            ...
            Settings.OI.putInt(getContentResolver(),
                    Settings.OI.GESTURE_ANYWHERE_ENABLED,
                    ((Boolean) newValue).booleanValue() ? 1 : 0);
            return true;
        } else if (preference == mTriggerWidthPref) {
            int width = ((Integer)newValue).intValue();
            Settings.OI.putInt(getContentResolver(),
                    Settings.OI.GESTURE_ANYWHERE_TRIGGER_WIDTH, width);
            return true;
        } else if (preference == mTriggerTopPref) {
            int top = ((Integer)newValue).intValue();
            Settings.OI.putInt(getContentResolver(),
                    Settings.OI.GESTURE_ANYWHERE_TRIGGER_TOP, top);
            return true;
        } else if (preference == mTriggerBottomPref) {
            int bottom = ((Integer)newValue).intValue();
            Settings.OI.putInt(getContentResolver(),
                    Settings.OI.GESTURE_ANYWHERE_TRIGGER_HEIGHT, bottom);
            return true;
        }
        return false;
    }
    ...
    private void updatePositionSummary(int value) {
        ...
        Settings.OI.putInt(getContentResolver(),
                Settings.OI.GESTURE_ANYWHERE_POSITION, value);
    }
    ...
    public void onPause() {
        super.onPause();
        Settings.OI.putInt(getContentResolver(),
                Settings.OI.GESTURE_ANYWHERE_SHOW_TRIGGER, 0);
    }
    ...
    public void onResume() {
        super.onResume();
        Settings.OI.putInt(getContentResolver(),
                Settings.OI.GESTURE_ANYWHERE_SHOW_TRIGGER, 1);
    }
}
