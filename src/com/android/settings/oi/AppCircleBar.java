...
public class AppCircleBar extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTriggerWidthPref.setValue(Settings.OI.getInt(getContentResolver(),
                Settings.OI.APP_CIRCLE_BAR_TRIGGER_WIDTH, 10));
        ...
        mTriggerTopPref.setValue(Settings.OI.getInt(getContentResolver(),
                Settings.OI.APP_CIRCLE_BAR_TRIGGER_TOP, 0));
        ...
        mTriggerBottomPref.setValue(Settings.OI.getInt(getContentResolver(),
                Settings.OI.APP_CIRCLE_BAR_TRIGGER_HEIGHT, 100));
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        ...
        if (preference == mIncludedAppCircleBar) {
            ...
            Settings.OI.putInt(getContentResolver(),
                    Settings.OI.APP_CIRCLE_BAR_TRIGGER_WIDTH, width);
            return true;
        } else if (preference == mTriggerTopPref) {
            int top = ((Integer)objValue).intValue();
            Settings.OI.putInt(getContentResolver(),
                    Settings.OI.APP_CIRCLE_BAR_TRIGGER_TOP, top);
            return true;
        } else if (preference == mTriggerBottomPref) {
            int bottom = ((Integer)objValue).intValue();
            Settings.OI.putInt(getContentResolver(),
                    Settings.OI.APP_CIRCLE_BAR_TRIGGER_HEIGHT, bottom);
            return true;
        }
    ...
    private Set<String> getIncludedApps() {
        String included = Settings.OI.getString(getActivity().getContentResolver(),
                Settings.OI.WHITELIST_APP_CIRCLE_BAR);
    ...
    private void storeIncludedApps(Set<String> values) {
        ...
        Settings.OI.putString(getActivity().getContentResolver(),
                Settings.OI.WHITELIST_APP_CIRCLE_BAR, builder.toString());
    }
    ...
    public void onPause() {
        super.onPause();
        Settings.OI.putInt(getContentResolver(),
                Settings.OI.APP_CIRCLE_BAR_SHOW_TRIGGER, 0);
    }
    ...
    public void onResume() {
        super.onResume();
        Settings.OI.putInt(getContentResolver(),
                Settings.OI.APP_CIRCLE_BAR_SHOW_TRIGGER, 1);
    }
}
