...
public class NetworkTrafficFragment extends SettingsPreferenceFragment implements OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.oi_network_traffic_settings);
        ...
        int intColor = Settings.OI.getInt(getContentResolver(),
                Settings.OI.NETWORK_TRAFFIC_VECTOR_COLOR, 0xffffffff);
        ...
        mNetTrafficAutohide.setChecked((Settings.OI.getInt(getContentResolver(),
                Settings.OI.NETWORK_TRAFFIC_VECTOR_AUTOHIDE, 0) == 1));
        mNetTrafficAutohide.setOnPreferenceChangeListener(this);

        mNetTrafficAutohideThreshold =
                (SeekBarPreferenceCham) prefSet.findPreference(NETWORK_TRAFFIC_AUTOHIDE_THRESHOLD);
        int netTrafficAutohideThreshold = Settings.OI.getInt(getContentResolver(),
                Settings.OI.NETWORK_TRAFFIC_VECTOR_AUTOHIDE_THRESHOLD, 10);
        ...
        if (TrafficStats.getTotalTxBytes() != TrafficStats.UNSUPPORTED &&
            ...
            mNetTrafficVal = Settings.OI.getInt(getContentResolver(),
                    Settings.OI.NETWORK_TRAFFIC_VECTOR_STATE, defaultState);
    ...
    private void NetworkTrafficColorReset() {
        Settings.OI.putInt(getContentResolver(),
                Settings.OI.NETWORK_TRAFFIC_VECTOR_COLOR, DEFAULT_TRAFFIC_COLOR);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mNetTrafficDisplay) {
            ...
            Settings.OI.putInt(getActivity().getContentResolver(),
                    Settings.OI.NETWORK_TRAFFIC_VECTOR_STATE, mNetTrafficVal);
            ...
            Settings.OI.putInt(getContentResolver(),
                    Settings.OI.NETWORK_TRAFFIC_VECTOR_COLOR, intHex);
            return true;  
            ...
            Settings.OI.putInt(getActivity().getContentResolver(),
                    Settings.OI.NETWORK_TRAFFIC_VECTOR_AUTOHIDE, value ? 1 : 0);
            return true;
        } else if (preference == mNetTrafficAutohideThreshold) {
            int threshold = (Integer) newValue;
            Settings.OI.putInt(getActivity().getContentResolver(),
                    Settings.OI.NETWORK_TRAFFIC_VECTOR_AUTOHIDE_THRESHOLD, threshold);
            return true;
        }
        return false;
    }
